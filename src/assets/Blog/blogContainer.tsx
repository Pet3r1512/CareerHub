...
export default function BlogContainer({ blog }: { blog: BlogProps }) {
  ...
  return (
    ...
    >
      <div className="w-96 lg:w-[420px] sm:h-[320px] lg:h-[355px] shadow-xl rounded-2xl py-2 cursor-default lg:hover:shadow-2xl px-4 flex gap-y-4 lg:gap-0 flex-col justify-between">
        <Image
          src={blog.img_url}
