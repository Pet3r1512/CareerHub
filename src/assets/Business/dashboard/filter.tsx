  ...
  return (
    <div className="flex lg:flex-row flex-col justify-between">
      ...
      <div className=" h-full bg-gray-500 border-2 border-gray-300 flex flex-col lg:flex-row">
        <Button className="rounded-none bg-gray-500 hover:bg-black hover:text-white">Pipeline View</Button>
        <Button className="rounded-none text-primary bg-white hover:bg-primary hover:text-white">
          Table View
        </Button>
      </div>
    </div>
